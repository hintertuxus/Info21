...
2. [Chapter II](#chapter-ii) \
    [Logical view of database model](#logical-view-of-database-model)
...
В данном проекте реализуется база данных, фиксирующая процесс обучения в Школе 21 (прохождение проектов, взаимодействие с пирами, взаимные и автоматизированные проверки). Для работы базы данных написаны процедуры и функции для получения информации, а также процедуры и триггеры для её изменения.
